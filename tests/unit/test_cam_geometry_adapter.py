...
def _selection(object_id: CadObjectId) -> SelectionMetadata:
    return SelectionMetadata(CadDocumentId("doc"), "face:stable-1", SelectionMode.FACE,
                             BoundingBox(0, 0, 0, 1, 1, 1), object_id)


def test_face_pick_uses_persistent_object_identity_and_source() -> None:
    ...
    assert reference.subshape_selector == "face:stable-1"
