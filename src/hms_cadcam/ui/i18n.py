...
CORE_TRANSLATIONS: tuple[tuple[str, str, str], ...] = (
    ...
    ("3D display", "HIỂN THỊ 3D", "3D 표시"),
    ("Viewport background color", "MÀU NỀN VÙNG HIỂN THỊ", "뷰포트 배경색"),
    (
        "Choose one stable solid background for CAD and Machining Simulation viewports.",
        "Chọn một màu nền đơn sắc ổn định cho vùng hiển thị CAD và Mô phỏng gia công.",
        "CAD 및 가공 시뮬레이션 뷰포트에 안정적인 단색 배경을 선택합니다.",
    ),
    ("Choose color…", "Chọn màu…", "색상 선택…"),
    ("CAM", "CAM", "CAM"),
    ("Child", "Con", "자식"),
    ...
    ("Reset Default", "Khôi phục mặc định", "기본값 복원"),
    ("OK", "Đồng ý", "확인"),
    ("Root", "Gốc", "루트"),
...
POST_STUDIO_UI_TRANSLATIONS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("post_studio.active.post", "Post đang dùng", "Active Post", "활성 포스트"),
    ("post_studio.active.revision", "Phiên bản", "Revision", "리비전"),
    ("post_studio.active.state", "Trạng thái", "Status", "상태"),
    ("post_studio.active.machine", "Máy", "Machine", "기계"),
    ("post_studio.active.controller", "Bộ điều khiển", "Controller", "컨트롤러"),
    ("post_studio.active.sha", "SHA đang dùng", "Active SHA", "활성 SHA"),
    ("post_studio.active.backup", "Backup", "Backup", "백업"),
    ("post_studio.active.rollback", "Rollback", "Rollback", "롤백"),
    ("post_studio.active.drift", "Drift", "Drift", "드리프트"),
    ("post_studio.active.activated_at", "Lần kích hoạt", "Activated at", "활성화 시각"),
    ("post_studio.active.r233_revision", "R233 khắc phục G40", "R233 G40 remediation", "R233 G40 수정"),
    ("post_studio.active.active", "ĐANG KÍCH HOẠT / ACTIVE", "ACTIVE", "활성"),
    ("post_studio.active.reconcile", "CẦN ĐỐI CHIẾU", "RECONCILIATION REQUIRED", "대조 필요"),
    ("post_studio.active.unreadable", "KHÔNG ĐỌC ĐƯỢC", "UNREADABLE", "읽을 수 없음"),
    ("post_studio.active.ready", "SẴN SÀNG", "READY", "준비됨"),
    ("post_studio.active.not_ready", "KHÔNG SẴN SÀNG", "NOT READY", "준비되지 않음"),
    ("post_studio.active.no_drift", "KHÔNG PHÁT HIỆN", "NOT DETECTED", "감지되지 않음"),
    ("post_studio.active.external_drift", "POST ĐÃ BỊ THAY ĐỔI NGOÀI HMS", "POST CHANGED OUTSIDE HMS", "HMS 외부에서 포스트 변경됨"),
)
