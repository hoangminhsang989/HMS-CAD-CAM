"""Production Reaming Function Editor schema."""
...
def build_reaming_schema(
    context: DrillingFamilyEditorContext,
) -> FunctionEditorSchema:
    """Build the Reaming v1 production editor."""
    if context.kind is not DrillingFamilyEditorKind.REAMING:
        raise ValueError("Reaming schema requires a Reaming context")
