...
class DiagnosticCode(StrEnum):
    ...
    BORE_INVALID_PARAMETERS = "bore.invalid_parameters"
    BORE_GEOMETRY_MISSING = "bore.geometry_missing"
    BORE_GEOMETRY_STALE = "bore.geometry_stale"
    BORE_GEOMETRY_AMBIGUOUS = "bore.geometry_ambiguous"
    BORE_SOURCE_MISMATCH = "bore.source_mismatch"
    BORE_TOOL_MISSING = "bore.tool_missing"
    BORE_TOOL_STALE = "bore.tool_stale"
    BORE_UNSUPPORTED_TOOL = "bore.unsupported_tool"
    BORE_DIAMETER_MISMATCH = "bore.diameter_mismatch"
    BORE_PREBORE_MISSING = "bore.prebore_missing"
    BORE_PREBORE_INVALID = "bore.prebore_invalid"
    BORE_STOCK_INVALID = "bore.stock_invalid"
    BORE_TOOL_ACCESS_INVALID = "bore.tool_access_invalid"
    BORE_CLEARANCE_INVALID = "bore.clearance_invalid"
    BORE_MACHINE_INCOMPATIBLE = "bore.machine_incompatible"
    BORE_DEPTH_INVALID = "bore.depth_invalid"
    ...
    Z_LEVEL_INVALID_PARAMETERS = "z_level.invalid_parameters"
    Z_LEVEL_NO_GEOMETRY = "z_level.no_geometry"
    Z_LEVEL_INVALID_FACE_REFERENCE = "z_level.invalid_face_reference"
    Z_LEVEL_INVALID_WORKPLANE = "z_level.invalid_workplane"
    Z_LEVEL_INVALID_TOOL = "z_level.invalid_tool"
    Z_LEVEL_UNSUPPORTED_TOOL = "z_level.unsupported_tool"
    Z_LEVEL_INVALID_STEPDOWN = "z_level.invalid_stepdown"
    Z_LEVEL_INVALID_TOLERANCE = "z_level.invalid_tolerance"
    Z_LEVEL_INVALID_ALLOWANCE = "z_level.invalid_allowance"
    Z_LEVEL_INVALID_BOUNDS = "z_level.invalid_bounds"
    Z_LEVEL_LEVEL_COUNT_EXCEEDED = "z_level.excessive_level_count"
    Z_LEVEL_CONTOUR_COUNT_EXCEEDED = "z_level.excessive_contour_count"
    Z_LEVEL_POINT_COUNT_EXCEEDED = "z_level.excessive_point_count"
    Z_LEVEL_INVALID_NORMAL = "z_level.singular_normal"
    Z_LEVEL_UNRESOLVED_ROOT = "z_level.unresolved_implicit_root"
    Z_LEVEL_AMBIGUOUS_TRIM = "z_level.ambiguous_trim_classification"
    Z_LEVEL_BRANCH_POINT = "z_level.branch_point"
    Z_LEVEL_OPEN_CONTOUR = "z_level.open_contour"
    Z_LEVEL_DUPLICATE_SEGMENT = "z_level.duplicate_segment"
    Z_LEVEL_SELF_INTERSECTION = "z_level.self_intersection"
    Z_LEVEL_INVALID_CONTACT = "z_level.invalid_contact"
    Z_LEVEL_LEVEL_DEVIATION = "z_level.level_deviation"
    Z_LEVEL_ALLOWANCE_DEVIATION = "z_level.allowance_deviation"
    Z_LEVEL_BOUNDARY_ESCAPE = "z_level.boundary_escape"
    Z_LEVEL_LINKING_COLLISION = "z_level.linking_collision"
    Z_LEVEL_SAFETY_UNKNOWN = "z_level.safety_unknown"
    Z_LEVEL_CANCELLED = "z_level.cancelled"
    Z_LEVEL_SUPERSEDED = "z_level.superseded"
